...
void ArrayCopyUsingAddArrayElement(int ArraySrc[100], int ArrayDes[100], int LengthOfArray, int& LengthOfArray2)
{
...
int main()
{
    ...
    ArrayCopyUsingAddArrayElement(ArraySrc,ArrayDes ,LengthOfArray, LengthOfArray2 );
    cout << endl;
